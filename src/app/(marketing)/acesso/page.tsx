    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-5 py-12 sm:px-8 sm:py-20" id="conteudo-principal" tabIndex={-1}>
        <div className="max-w-3xl">
          <p className="text-sm font-bold uppercase tracking-wide text-brand">Acesso à Plataforma</p>
          <h1 className="mt-4 text-balance font-display text-fluid-title text-ink">Acompanhar o desenvolvimento também é escutar.</h1>
        ...
        <section aria-labelledby="entradas-title" className="mt-12">
          <h2 id="entradas-title" className="text-balance font-display text-3xl leading-tight text-ink sm:text-4xl">Escolha seu acesso</h2>
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            <article className="glass-surface rounded-4xl p-7 transition-[transform,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-glass sm:p-9">
              <Heart aria-hidden="true" className="text-brand" size={30} />
              <h3 className="mt-5 text-balance font-display text-2xl sm:text-3xl">Responsáveis</h3>
            ...
            <article className="glass-surface rounded-4xl p-7 transition-[transform,box-shadow] duration-200 hover:-translate-y-1 hover:shadow-glass sm:p-9">
              ...
              <h3 className="mt-5 text-balance font-display text-2xl sm:text-3xl">Educadores e escolas</h3>
        ...
        <section aria-labelledby="principios-title" className="mt-14 rounded-4xl bg-ink px-7 py-9 text-inverse sm:px-10">
          <div className="flex items-start gap-4">
            <BookOpenCheck aria-hidden="true" className="mt-1 shrink-0 text-accent" size={28} />
            <div>
              <h2 id="principios-title" className="text-balance font-display text-3xl leading-tight sm:text-4xl">Compromissos desde o início</h2>
              <ul className="mt-5 space-y-3 text-inverse/85">
